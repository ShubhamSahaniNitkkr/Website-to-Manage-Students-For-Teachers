      ...
      <nav class="navbar navbar-default" style="padding:0px 88px 0px;width:1550px;top: -14px;left: 16px;">
        <div class="container-fluid containerfluid">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li>"><a href="#" class=" hidden-xs" style="color:white;margin-top: -30px;" data-toggle="tooltip" title="Log out!" data-placement="bottom"><img src="images/user_pic.svg" class="img-circle"  width="40px" height="40px"alt="">&nbsp;<span id="logout"></span></a></li>
            </ul>
        </div>
      </nav>
        ...
        <div class="col-md-12 content clonecontainer" style="margin-left:-36px;">
          ...
          <div class="card">
            <!-- <a href="classperformance.php"> -->
              ...
              <!-- $(this).child('.class_id').val() -->
              <div class="card_body" >

                <p class="class_id" style="color:grey;font-weight:300;word-wrap:break-word;display:none;" ></p>
                <p class="classname" style="color:grey;font-weight:300;word-wrap:break-word;"></p>
              ...
              <div class="img_section">
                ...
                <button type="button"  class="card_footer btn btn-default" style="background-color:white;border: 1px solid gainsboro;" name="button"><span class="no_of_students">0</span>&nbsp;Students</button>
                </div>
              <!-- </a> -->
            </div>
          </div>
...
<!-- Modal 1 -->
  ...
  <div class="modal-dialog">
      ...
      <br>
            <!-- content goes here -->
              <div class="form-group">
                ...
                <input type="text" class="form-control required" id="text" autocomplete="off" placeholder="Example: B.Tech Section A" id="field">
              </div>
   ...
   <button type="button submit_buttons" class="btn btn-default submit_buttons" style="text-align:center" id="start_button" data-toggle="modal" data-disiss="modal" data-target="#Moda2" class="close"> <a style="text-decoration: none; onMouseOver="this.style.color='white'" onMouseOut="this.style.color='white'" ">Invite Students </a></button>
